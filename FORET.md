...
| 2026-05-12 | Public release prep found repo hygiene issues | Removed the legacy migration endpoint, scrubbed private infrastructure access notes from public docs, replaced secret-shaped env placeholders, and added a JSON body-size limit. Public repos should show how to configure the app, not where the control plane lives. |
