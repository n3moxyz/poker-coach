  ...
  const positionQuestions = [
    {
      ...
      content: {
        ...
        options: ['Button', 'Big Blind', 'Small Blind', 'Cutoff'],
    ...
    },
    {
      ...
      content: {
        ...
        options: ['Cutoff', 'Center Off', 'Cash Out', 'Check Option'],
      },
    ...
    },
    {
      ...
      content: {
        ...
        options: ['Button', 'Big Blind', 'Under the Gun', 'Small Blind'],
      },
      correctAnswer: 'Button',
    ...
    },
    {
      ...
      content: {
        ...
        options: ['Under the Gun', 'Up Top Game', 'Ultimate Table Game', 'Under the Ground'],
      },
  ...
  const potOddsQuestions = [
    ...
    },
    {
      ...
      content: {
        ...
        options: ['Yes - pot odds are good', 'No - not enough equity', 'Only if short-stacked', 'Need more information'],
      },
  ...
  const preflopQuestions = [
    {
      ...
      content: {
        ...
        options: ['Raise', 'Limp', 'Fold', 'All-in'],
      },
      correctAnswer: 'Raise',
    ...
    },
    {
      ...
      content: {
        ...
        options: ['Fold', 'Raise', 'Limp', 'Call any bet'],
      },
      correctAnswer: 'Fold',
    ...
    },
    {
      ...
      content: {
        ...
        options: ['Raise', 'Fold', 'Limp', 'Min-raise only'],
      },
      correctAnswer: 'Raise',
    ...
    },
    {
      ...
      content: {
        ...
        options: ['Call', 'Fold', 'Raise (3-bet)', 'All-in'],
      },
      correctAnswer: 'Call',
    ...
    },
    {
      ...
      content: {
        ...
        options: ['AA, KK, QQ, AK', 'Any pair', 'Any suited cards', 'Any ace'],
      },
    ...
    },
    {
      ...
      content: {
        ...
        options: ['Raise', 'Complete (limp)', 'Fold', 'All-in'],
      },
      correctAnswer: 'Raise',
  ...
  const scenarioQuestions = [
    {
      ...
      content: {
        ...
        options: ['4-bet', 'Call', 'Fold', 'All-in'],
      },
      correctAnswer: '4-bet',
    ...
    },
    {
      ...
      content: {
        ...
        options: ['Fold', 'Call', 'Raise', 'Check-raise all-in'],
      },
      correctAnswer: 'Fold',
    ...
    },
    {
      ...
      content: {
        ...
        options: ['Check and evaluate', 'Donk bet for protection', 'Check-raise', 'Lead all-in'],
      },
    ...
    },
    {
      ...
      content: {
        ...
        options: ['Raise (semi-bluff)', 'Call', 'Fold', 'All-in'],
      },
    ...
    },
    {
      ...
      content: {
        ...
        question: 'What should you do?',
        options: ['Call', 'Fold', 'Never happens', 'Ask for count'],
      },
      correctAnswer: 'Call',
